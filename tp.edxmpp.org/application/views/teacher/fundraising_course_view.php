...
<main>
    <div class="container mbr-3 mtr-10 fundraising_course_body">

        <div class="input-title col-sm-12 ft-24 mbr-3">募資課程資訊</div>

        <div class="mls-15">
            <form id="fundraising_course_form" enctype="multipart/form-data" method="post">
                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">課程名稱<span class="error-text basic-data-error">課程名稱不可為空</span></div>
                    <input type="text" class="form-control fundraising_course-data" value="">
                </div>
                ...
                <div class="input-group col-sm-6 mb-3">
                    ...
                    <input type="text" class="form-control fundraising_course-data" id="video_url_input" value="">
                ...
                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">上課類型<span class="error-text basic-data-error">請選擇上課類型</span></div>
                ...
                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">課程簡介<span
                                class="error-text basic-data-error">課程簡介不可為空</span></div>
                ...
                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">課程時數<span class="error-text basic-data-error">課程時數不可為空</span></div>
                    <input type="number" class="form-control fundraising_course-data" value="">
                </div>

                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">原始價格<span class="error-text basic-data-error">原始價格不可為空</span></div>
                    <input type="number" class="form-control fundraising_course-data" value="">
                </div>

                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">募資價格<span class="error-text basic-data-error">募資價格不可為空</span></div>
                    <input type="number" class="form-control fundraising_course-data" value="">
                </div>

                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">預計人數<span class="error-text basic-data-error">預計人數不可為空</span></div>
                    <input type="number" class="form-control fundraising_course-data" value="">
                </div>

                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">募資結束時間<span class="error-text basic-data-error">募資結束時間不可為空</span></div>
                    <input type="datetime-local" class="form-control fundraising_course-data" value="">
                </div>
                ...
                <div class="input-group col-sm-6 mb-3">
                    <div class="input-title col-sm-12">課程標籤
                        ...
                        <span class="error-text basic-data-error">課程標籤不可為空</span></div>
...
<script>
    $(document).ready(function () {
        ...
        $("#fundraising_course_form").submit(function (event) {             //阻止自動提交
