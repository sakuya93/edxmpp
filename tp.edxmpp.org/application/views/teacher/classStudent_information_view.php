...
<head>
    ...
    <link rel="stylesheet" href="../resource/css/teacher/classStudent_information.css">
            ...
            <main style="margin: 0 auto;">
                <div id="toolbar">
                    ...
                    <div class="select mt-10 row col-sm-12 flex-nowrap" style="width: 480px">
                        <h3 class="col-sm-6">課程選項:</h3>
                        <select class="form-control col-sm-6" id="course_options" onchange="course_options()">
                            <?= $option ?>
                        </select>
                    </div>
                </div>
                ...
                <table
                        ...
                        data-url="../classStudent_information_fun/getFilmComment"
...
<script src="../resource/js/teacher/classStudent_information.js"></script>
