...
<body>
<div id="teams_liveManagement_room_window" class="modal" tabindex="-1">
    <div class="modal-dialog" role="document" id="dialog">
        <div class="modal-content" id="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="teams_liveManagement_room_Title">直播課程詳細內容</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" id="teams_liveManagement_room_text">
                <span><b>課程名稱 : </b></span>
            ...
            <div class="modal-footer">
                <button type="button" id="complete" class="btn btn-primary" data-dismiss="modal">創建</button>
