...
<body>
<div id="notice_record_window" class="modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document" id="dialog">
        <div class="modal-content" id="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="notice_record_Title">通知新增區</h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" id="notice_record_text">
                <h6><b>通知對象 : </b></h6>
                <select class="form-control col-sm-6" id="notice_object" onchange="sel_object(this.value)">
                ...
                <br>
                <h6><b>特定ID : </b><i class="fa fa-info-circle" id="specific_ID_hint_icon" style="font-size: 20px;cursor: pointer"></i></h6>
                <input type="text" class="form-control" id="specific_ID" autocomplete="off" disabled>
...
<script>
    ...
    $('#notice_record_window').on('shown.bs.modal', function () {
