...
<!--                            <input type="radio" id="option__IssueManagement" name="reportManagementOption__control" class="custom-control-input" value="Issue" checked>-->
<!--                            <label class="custom-control-label" for="option__IssueManagement">發放</label>-->
<!--                        </div>-->
<!--                        <div class="custom-control custom-radio custom-control-inline">-->
<!--                            <input type="radio" id="option__storedValueManagement" name="reportManagementOption__control" class="custom-control-input" value="storedValue">-->
<!--                            <label class="custom-control-label" for="option__storedValueManagement">儲值</label>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
                ...
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <button class="btn btn-outline-danger" onclick="handOutDiamonds();">
...
<script src="resource/js/admin/hand_outDiamonds.js"></script>
