...
<head>
    ...
    <link rel="stylesheet" href="resource/css/admin/teams_account_issues.css">
    ...
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                ...
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <h3 class="col-sm-6" style="min-width: 200px;margin-left: -15px">發放狀態:</h3>
                    <!--  預設抓未開放   -->
                    <select class="form-control col-sm-6" id="sel_issues_status" onchange="sel_issues_status()">
                        <option value="0" selected>未發放</option>
                        <option value="1" >發放</option>
                    </select>
                </div>
            </div>
            ...
            <table
                ...
                data-url="teams_account_issues/getTeacherData/0"
...
<script src="resource/js/admin/teams_account_issues.js"></script>
