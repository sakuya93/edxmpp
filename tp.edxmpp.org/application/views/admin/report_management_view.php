    ...
    <div class="row flex-xl-nowrap d-flex justify-content-center">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <div style="padding: 0 15px">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="option__reportedManagement" name="reportManagementOption__control" class="custom-control-input" value="getClassReport|getStudentReport" checked>
                            <label class="custom-control-label" for="option__reportedManagement">被檢舉管理</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="option__personalReportedManagement" name="reportManagementOption__control" class="custom-control-input" value="getReportRecord">
                            <label class="custom-control-label" for="option__personalReportedManagement">個人檢舉記錄管理</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <h3 class="col-sm-6">月份選項:</h3>
                    <input type="month" class="form-control col-sm-6" id="date">
                </div>

                <div class="select mt-10 row col-sm-12 flex-nowrap" style="width: 480px">
                    <h3 class="col-sm-6">檢舉對象:</h3>
                    <select class="form-control col-sm-6" id="reportIdentify">
                        <option value="getClassReport" selected>老師</option>
                        <option value="getStudentReport">學生</option>
                    </select>
                </div>
            </div>
...
<script src="resource/js/admin/report_management.js"></script>
