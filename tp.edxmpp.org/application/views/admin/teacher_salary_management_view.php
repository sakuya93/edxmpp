        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                ...
                <div class="select mt-10 row col-sm-12 flex-nowrap" style="width: 480px">
                    <h3 class="col-sm-6">薪資狀態:</h3>
                    <select class="form-control col-sm-6" id="status">
                        <option value="0" selected>未匯款</option>
...
<script src="resource/js/admin/teacher_salary_management.js"></script>
