...
<head>
    ...
    <link rel="stylesheet" href="resource/css/admin/course_options.css">
    ...
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                ...
                <button type="button" class="btn btn-primary" onclick="add_option()">新增</button>
                <button type="button" class="btn btn-danger" onclick="del_option()">刪除</button>
            </div>
            ...
            <table
                ...
                data-url="course_options/load_table_data"
...
<script src="resource/js/admin/course_options.js"></script>
