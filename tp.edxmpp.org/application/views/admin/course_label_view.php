...
<!--    <link rel="stylesheet" href="resource/css/admin/course_label.css">-->
    ...
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                ...
                <button type="button" class="btn btn-primary" onclick="addLabel()">新增</button>
                <button type="button" class="btn btn-danger" onclick="deleteLabel()">刪除</button>
            </div>
            ...
            <table
                ...
                data-url="course_label/getLabel"
...
<script src="resource/js/admin/course_label.js"></script>
