            ...
            <div id="toolbar">
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <div style="padding: 0 15px" class="display_sel_history">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="option__diamond_StoredValue" name="reportManagementOption__control"
                ...
                <div class="row col-sm-12 mt-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" value="0" min="0" max="100" aria-label="Amount (to the nearest dollar)" id="inputSalesCommission">
                        <div class="input-group-append">
                            <span class="input-group-text">%</span>
                            <button class="btn btn-outline-success" type="button" onclick='setSalesCommisstion()'>修改確認</button>
                        </div>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" id="earned_amount" class="form-control" value="0" aria-label="Amount (to the nearest dollar)" disabled>
                        <div class="input-group-append">
                ...
                <div class="select mt-10 row col-sm-12 flex-nowrap">
                    <button class="btn btn-outline-danger" onclick="clearExpiredPaymentHistory();">
...
<script src="resource/js/admin/payment_history.js"></script>
