...
<head>
    ...
    <link rel="stylesheet" href="resource/css/admin/notice_record.css">
    ...
    <div class="row flex-xl-nowrap">
        ...
        <main class="col-12 col-md-10 col-xl-10 py-md-3 pl-md-5 bd-content">
            ...
            <div id="toolbar">
                ...
                <div class="btn_area">
                    <button type="button" class="btn btn-primary" onclick="addNoticeRecord()">新增通知</button>
                    <button type="button" class="btn btn-danger" onclick="deleteNoticeRecord()">刪除通知</button>
                </div>
            </div>
            ...
            <table
                ...
                data-url="notice_record/getNoticeRecord/0"
...
<script src="resource/js/admin/notice_record.js"></script>
