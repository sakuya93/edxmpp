...
function get_payment_history(date) { //取得付款紀錄並呼叫生成master table
    ...
    $.ajax({
        type: "POST",
        url: "buy_record/getPaymentHistoryPoint",
        data: convey_data,
        dataType: 'json',
        success: function (res) {
            initTable(false, "", res);
...
function get_payment_history_class(date) { //取得課程購買紀錄並呼叫生成master table
    ...
    $.ajax({
        type: "POST",
        url: "buy_record/getPaymentHistoryClass",
        data: convey_data,
        dataType: 'json',
        success: function (res) {
...
function clearExpiredPaymentHistory() {
    $.ajax({
        type: "POST",
        url: "buy_record/clearExpiredPaymentHistory",
        success: function (res) {
            $("#hint_text").text("清除成功!");
            $("#hint_window").modal();
        },
...
function buildSubTableOfPaymentHistory(index, row, $detail, data) {
    ...
    $.ajax({
        type: "POST",
        url: "buy_record/getOrderClassData",
        data: convey_data,
        dataType: 'json',
        success: function (res) {
            console.log(res);
